...
$target_user_ids = array_map(
 ...
 $target_user_ids[] = $_SESSION['login_user_id'];
 $sql = 'SELECT bbs_entries.*, users.name AS user_name, users.icon_filename AS user_icon_filename'
   ...
   . ' LEFT JOIN user_relationships ON bbs_entries.user_id = user_relationships.followee_user_id'
   . ' WHERE (bbs_entries.user_id = :login_user_id)'
   . ' OR (user_relationships.follower_user_id = :follower_id)'
